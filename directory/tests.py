...
'''.strip()
        ...
        self.assertEqual(teacher.first_name, "Shefeek"),
        self.assertEqual(teacher.last_name, "Najeeb"),
        self.assertEqual(teacher.email, "test@email.com"),
        self.assertEqual(teacher.phone, "+971-9999999"),
        self.assertEqual(teacher.image, models.ImageField('tempfile.png').name),
        self.assertEqual(teacher.room, "206"),
        self.assertEqual(teacher.subjects, "CS"),